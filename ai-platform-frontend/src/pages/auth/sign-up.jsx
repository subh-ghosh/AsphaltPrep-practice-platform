              ...
              >
                ...
                <MagneticButton className="w-full rounded-full">
                  <button
                    ...
                    className="w-full bg-[#181717] hover:bg-[#24292e] text-white border border-white/10 rounded-full py-2.5 px-4 flex items-center justify-center gap-3 font-medium transition-all shadow-md"
                  >
